...
export const Darmstadium: Element   = new Element({name: "Darmstadium",   symbol: "Ds", family: "unknown",             atomicNumber: 110, group: 10,           period: 7, fullElectronConfiguration: "1s2 2s2 2p6 3s2 3p6 3d10 4s2 4p6 4d10 4f14 5s2 5p6 5d10 5f6 6s2 6p6 6d8 7s2",      nobleGasElectronConfiguration: "[Rn] 5f6 6d8 7s2"});
...
export const Tenessine: Element     = new Element({name: "Tenessine",     symbol: "Ts", family: "unknown",             atomicNumber: 117, group: 17,           period: 7, fullElectronConfiguration: "1s2 2s2 2p6 3s2 3p6 3d10 4s2 4p6 4d10 4f14 5s2 5p6 5d10 5f6 6s2 6p6 6d10 7s2 7p5", nobleGasElectronConfiguration: "[Rn] 5f6 6d10 7s2 7p5"});
