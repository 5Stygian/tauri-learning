...
export const Copper: Element        = new Element({name: "Copper",         symbol: "Cu", family: "transitionMetal",     atomicNumber: 29, group: 11,           period: 4, fullElectronConfiguration: "1s2 2s2 2p6 3s2 3p6 3d9 4s2",                                                      nobleGasElectronConfiguration: "[Ar] 3d9 4s2"});
