...
export default function ElementCard() {
  ...
  const dataTableStyling = `min-w-220 w-min min-h-40 bg-black border-3 shadow-2x1 font-bold ${NaE.color} flex justify-center items-center ml-8 px-8 py-12 hover:cursor-default`;
