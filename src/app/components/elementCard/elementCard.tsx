...
export default function ElementCard() {
  ...
  const dataTableStyling = `basis-3xs w-min min-h-40 bg-black border-3 shadow-2x1 font-bold ${NaE.color} flex justify-center items-center ml-8 px-8 py-6 hover:cursor-default`;
